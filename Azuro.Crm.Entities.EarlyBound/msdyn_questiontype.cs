...
namespace Azuro.Crm.Entities
{
	...
	public partial class msdyn_questiontype : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public const string PrimaryIdAttribute = "msdyn_questiontypeid";
		...
		public System.Nullable<Azuro.Crm.Entities.msdyn_questiontypeState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Azuro.Crm.Entities.msdyn_questiontypeState)(System.Enum.ToObject(typeof(Azuro.Crm.Entities.msdyn_questiontypeState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Azuro.Crm.Entities.msdyn_feedbackmapping> msdyn_feedbackmapping_LinkedQuestionId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Azuro.Crm.Entities.msdyn_feedbackmapping>("msdyn_feedbackmapping_LinkedQuestionId", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msdyn_feedbackmapping_LinkedQuestionId");
				this.SetRelatedEntities<Azuro.Crm.Entities.msdyn_feedbackmapping>("msdyn_feedbackmapping_LinkedQuestionId", null, value);
		...
		public System.Collections.Generic.IEnumerable<Azuro.Crm.Entities.msdyn_linkedanswer> msdyn_msdyn_questiontype_msdyn_linkedanswer_LinkedQuestion
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Azuro.Crm.Entities.msdyn_linkedanswer>("msdyn_msdyn_questiontype_msdyn_linkedanswer_LinkedQuestion", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msdyn_msdyn_questiontype_msdyn_linkedanswer_LinkedQuestion");
				this.SetRelatedEntities<Azuro.Crm.Entities.msdyn_linkedanswer>("msdyn_msdyn_questiontype_msdyn_linkedanswer_LinkedQuestion", null, value);
		...
		public System.Collections.Generic.IEnumerable<Azuro.Crm.Entities.msdyn_question> msdyn_question_questiontype
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Azuro.Crm.Entities.msdyn_question>("msdyn_question_questiontype", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msdyn_question_questiontype");
				this.SetRelatedEntities<Azuro.Crm.Entities.msdyn_question>("msdyn_question_questiontype", null, value);
		...
		public System.Collections.Generic.IEnumerable<Azuro.Crm.Entities.msdyn_questionresponse> msdyn_questiontype_questionresponse_questiontypelookup
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Azuro.Crm.Entities.msdyn_questionresponse>("msdyn_questiontype_questionresponse_questiontypelookup", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msdyn_questiontype_questionresponse_questiontypelookup");
				this.SetRelatedEntities<Azuro.Crm.Entities.msdyn_questionresponse>("msdyn_questiontype_questionresponse_questiontypelookup", null, value);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statuscode")]
		public virtual msdyn_questiontype_StatusCode? StatusCodeEnum
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((msdyn_questiontype_StatusCode?)(EntityOptionSetEnum.GetEnum(this, "statuscode")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
