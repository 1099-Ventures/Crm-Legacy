...
namespace Azuro.Crm.Entities
{
	...
	public partial class msdyn_icebreakersconfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Azuro.Crm.Entities.msdyn_icebreakersconfigState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Azuro.Crm.Entities.msdyn_icebreakersconfigState)(System.Enum.ToObject(typeof(Azuro.Crm.Entities.msdyn_icebreakersconfigState), optionSet.Value)));
				}
				else
				{
					return null;
