...
namespace Azuro.Crm.Entities
{
	...
	public partial class CampaignItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Azuro.Crm.Entities.Campaign> campaigncampaign_association
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Azuro.Crm.Entities.Campaign>("campaigncampaign_association", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("campaigncampaign_association");
				this.SetRelatedEntities<Azuro.Crm.Entities.Campaign>("campaigncampaign_association", null, value);
		...
		public System.Collections.Generic.IEnumerable<Azuro.Crm.Entities.Campaign> campaignproduct_association
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Azuro.Crm.Entities.Campaign>("campaignproduct_association", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("campaignproduct_association");
				this.SetRelatedEntities<Azuro.Crm.Entities.Campaign>("campaignproduct_association", null, value);
		...
		public System.Collections.Generic.IEnumerable<Azuro.Crm.Entities.Campaign> campaignsalesliterature_association
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Azuro.Crm.Entities.Campaign>("campaignsalesliterature_association", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("campaignsalesliterature_association");
				this.SetRelatedEntities<Azuro.Crm.Entities.Campaign>("campaignsalesliterature_association", null, value);
