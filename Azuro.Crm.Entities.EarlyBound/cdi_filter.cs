...
namespace Azuro.Crm.Entities
{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("cdi_filter")]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "9.0.0.9369")]
	public partial class cdi_filter : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		
		public static class Fields
		{
			public const string cdi_filterId = "cdi_filterid";
			public const string Id = "cdi_filterid";
		...
		public const string EntityLogicalName = "cdi_filter";
		
		public const string PrimaryIdAttribute = "cdi_filterid";
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cdi_filterid")]
		public System.Nullable<System.Guid> cdi_filterId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("cdi_filterid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("cdi_filterId");
				this.SetAttributeValue("cdi_filterid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
				...
				this.OnPropertyChanged("cdi_filterId");
			}
		}
		...
		public System.Nullable<Azuro.Crm.Entities.cdi_filterState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Azuro.Crm.Entities.cdi_filterState)(System.Enum.ToObject(typeof(Azuro.Crm.Entities.cdi_filterState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Reason for the status of the Filter
		/// </summary>
		...
		/// </summary>
		[System.Diagnostics.DebuggerNonUserCode()]
		public cdi_filter(object anonymousType) : 
				this()
		{
            foreach (var p in anonymousType.GetType().GetProperties())
            {
                ...
                switch (name)
                {
                    case "id":
                        ...
                        Attributes["cdi_filterid"] = base.Id;
                        break;
                    case "cdi_filterid":
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cdi_type")]
		public virtual cdi_filter_cdi_type? cdi_typeEnum
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((cdi_filter_cdi_type?)(EntityOptionSetEnum.GetEnum(this, "cdi_type")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statuscode")]
		public virtual cdi_filter_StatusCode? StatusCodeEnum
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((cdi_filter_StatusCode?)(EntityOptionSetEnum.GetEnum(this, "statuscode")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
